...
public class admin extends javax.swing.JFrame {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated Code">
    private void initComponents() {
        ...
        jTextField6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select...", "Male", "Female" }));
...
if(txt_st.getText().isEmpty() ||txt_room.getText().isEmpty() || jTextField7.getText().isEmpty()|| jTextField7.getText().isEmpty()|| jTextField7.getText().isEmpty()){
 ...
 /*   private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
      //    p = JOptionPane.showConfirmDialog(null, "Are you sure you want to update?","Update Record",JOptionPane.YES_NO_OPTION);
        if(p==0){
